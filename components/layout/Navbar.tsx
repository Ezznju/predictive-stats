      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/tools" className="text-sm text-black/70 hover:text-black transition-colors font-medium">Tools</Link>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-surface-border bg-white shadow-lg">
          <nav className="px-4 py-4 space-y-1">
            ...
            <Link href="/tools" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm text-black/70 hover:text-black hover:bg-surface/30 rounded-lg transition-colors">Tools</Link>
