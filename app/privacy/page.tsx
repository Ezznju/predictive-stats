...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <h1 className="font-display font-bold text-4xl text-white mb-8">Privacy Policy</h1>
      <div className="prose prose-invert max-w-none prose-headings:font-display prose-p:text-slate-400 prose-li:text-slate-400 prose-h2:text-xl prose-h2:text-white">
        ...
        <p>{siteSettings.siteName} collects minimal personal information. If you subscribe to our newsletter, we collect your email address. We use analytics to understand site traffic, which may collect anonymized usage data such as pages visited, time on site, and referral sources.</p>
