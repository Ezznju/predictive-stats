...
export default function NewsletterPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <h1 className="font-display font-bold text-4xl text-white mb-4">The Weekly Signal</h1>
      ...
      <div className="mt-12 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div key={item.title} className="p-4 bg-surface-raised rounded-lg border border-surface-border">
